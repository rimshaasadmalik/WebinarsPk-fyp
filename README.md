# SB Admin rewritten in Angular10 and Bootstrap 4

Simple Dashboard Admin App built using Angular 10 and Bootstrap 4

This project is a port of the famous Free Admin Bootstrap Theme [SB Admin v8.0](http://startbootstrap.com/template-overviews/sb-admin-2/) to Angular10 Theme.
...
`sb-admin-bs4-angular10` provides the following features:
